...
app.get('/login', (req, res) => {
    ...
    <style>
        ...
        input { width:100%; padding:14px; border-radius:12px; border:1px solid #ddd; margin:20px 0; box-sizing:border-box; font-size:16px; text-align:center; outline:none; }
...
app.get('/admin', async (req, res) => {
    ...
    <style>
        ...
        input, select { width:100%; padding:12px; border-radius:10px; border:1px solid #ddd; outline:none; box-sizing:border-box; font-size:16px; }
            ...
            document.getElementById('fa').onsubmit = async (e) => {
                ...
                try {
                    ...
                    await fetch('/add-ajax', { method:'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify({ 
                        judul: document.getElementById('j').value, penulis: document.getElementById('p').value, harga: Number(rawHarga), genre: document.getElementById('g').value, gambar: iD.data.url 
                    }) });
                    location.reload();
